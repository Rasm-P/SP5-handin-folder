...
- Create two local databases (on your vagrant image) named exactly (exactly is only for this proof of concept) as below:
  - `person`
  - `person_test`
- Create a REMOTE database on your Droplet named exacly like this: `person`
...
`export CONNECTION_STR="jdbc:mysql://localhost:3306/person"
`
...
- If everything was fine the project should be deployed to your droplet, ready to use with the remote database. Test like this:
  - `URL_FOR_YOUR_DROPLET/rest-jpa-devops-starter/api/persons`  (This does not use the database)
  - `URL_FOR_YOUR_DROPLET/rest-jpa-devops-starter/api/persons/count` (This queries the database)
